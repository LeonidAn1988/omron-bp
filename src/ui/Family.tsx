        ...
        {!family.supported ? (
          ...
          <>
            <p className="muted" style={{ marginTop: 0 }}>
              Приложение читает копии других телефонов каждый раз, когда вы его открываете, и добавляет из них новое.
              Ваши записи уходит туда же — обычной копией.
            </p>
            ...
            {family.sources.length === 0 ? (
              <div className="muted">
                Пока ни одного. Добавьте файл копии другого телефона — тот, что лежит в общей папке.
              </div>
            ) : (
              <ul className="pills">
