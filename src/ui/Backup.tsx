  ...
  return (
    <div className="card">
      ...
      <div className="stack" style={{ gap: 'var(--space-4)' }}>
        ...
        {supported && (
          <p className="muted" style={{ margin: 0 }}>
            Файл кладут куда угодно: в облачную папку или прямо в память телефона. Облако нужно только для того,
            чтобы копия пережила потерю телефона.
          </p>
        )}
        ...
        <div>
          <div className="tile__label">Где лежат записи</div>
          <div style={{ marginTop: 4 }}>
            {isNative() ? (
              <>
      ...
      <Banner tone="info">
        ...
        <div style={{ marginTop: 4 }}>
          Приложение никуда его не отправляет само. Чтобы данные пережили потерю телефона, копия должна лежать за его
          пределами — в облачной папке.
        </div>
      </Banner>
    </div>
  )
