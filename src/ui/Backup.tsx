      ...
      <div className="stack" style={{ gap: 'var(--space-4)' }}>
        ...
        {!supported && (
          <p className="muted" style={{ margin: 0 }}>
            Этот браузер не умеет дописывать файл сам, поэтому копию нужно сохранять кнопкой. Приложение напомнит,
            если с последней копии пройдёт больше {STALE_DAYS} дней с новыми записями.
          </p>
        )}

        <div>
          <div className="tile__label">Хранилище браузера</div>
          <div style={{ marginTop: 4 }}>
