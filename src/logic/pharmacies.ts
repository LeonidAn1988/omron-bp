 ...
 *
 * Адреса проверены на телефоне 5 сентября 2026: у каждой сети открыт запрос и
 * получен список товаров. Параметр у всех свой, и угадать его нельзя — он снят
 * с формы поиска самого сайта: `q` у Аптеки.ру, ЕАптеки, Мегаптеки и Планеты
 * Здоровья, `what` у Здравсити, `query` у Ютеки.
 */
...
export const PHARMACIES: Pharmacy[] = [
  ...
  { id: 'zdravcity', name: 'Здравсити', search: 'https://zdravcity.ru/search/?what={q}' },
  { id: 'uteka', name: 'Ютека', search: 'https://uteka.ru/search/?query={q}' },
  { id: 'planeta', name: 'Планета Здоровья', search: 'https://planetazdorovo.ru/search/?q={q}' },
]
