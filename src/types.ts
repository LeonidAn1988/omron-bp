 ...
 *
 * Приёма лекарств здесь нет намеренно — только остатки и сроки. Напоминания о
 * приёме требуют системного планировщика, которого в браузере нет; они появятся
 * на нативном этапе (см. BACKLOG.md, пункт 5).
 */
export interface Medicine {
  id: string
  /** Название с упаковки. */
  name: string
  /** Дозировка и форма как написано на коробке: «5 мг», «10 мг/мл». Свободный текст: вариантов слишком много. */
  dose: string
  /**
