...
/**
 * Одно напоминание: каждый день в заданное время.
 *
 * Сложнее не нужно. Лекарства принимают по часам, а не по календарю с
 * исключениями; всё остальное — курс, перерывы, «через день» — приложение
 * считает само и просто не ставит напоминание на день, когда приёма нет.
 */
...
export interface RemindersPort {
  ...
  /** Сколько напоминаний действительно стоит в системе — для честного показа. */
  ...
  /** Открыть настройки приложения: там снимаются ограничения энергосбережения. */
